...
>>> print browser.contents
<...
     <span class="result">http://xml.zeit.de/authors/S/William_Shakespeare/index</span>
...
>>> browser.open('http://localhost/++skin++vivi/repository/authors/S/William_Shakespeare/index')
>>> print browser.contents
<...
    <label for="form.firstname">...
    <div class="widget">William</div>...
