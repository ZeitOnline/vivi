...
class Form(zeit.content.article.edit.browser.testing.BrowserTestCase):
    def test_inline_form_saves_values(self):
        ...
        b.reload()
        self.assertEqual('John Doe', b.getControl('Attribution', index=0).value)
...
class FormLoader(zeit.content.article.edit.browser.testing.EditorTestCase):
    def test_citation_form_is_loaded(self):
        ...
        s.assertElementPresent('css=.block.type-citation .inline-form .field.fieldname-text')
        s.assertElementPresent('css=.block.type-citation .inline-form .field.fieldname-attribution')
