...
class Form(zeit.content.article.edit.browser.testing.BrowserTestCase):
    def test_inline_form_saves_values_for_box(self):
        ...
        article = self.get_article(with_block='box')
        zope.interface.alsoProvides(article, zeit.arbeit.interfaces.IZARContent)
        b = self.browser
        ...
        b.getControl(name='form.layout').displayValue = ['Zeit Arbeit Profilbox']
        ...
        self.assertEqual(['Zeit Arbeit Profilbox'], b.getControl(name='form.layout').displayValue)
