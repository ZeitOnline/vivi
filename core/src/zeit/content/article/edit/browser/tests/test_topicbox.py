...
class Form(zeit.content.article.edit.browser.testing.BrowserTestCase):
    ...
    def test_topicbox_source_manual_form_saves_values(self):
        ...
        b.getControl('Source').displayValue = ['manual']
        ...
        self.assertEqual([
            'manual'], b.getControl('Source').displayValue)
    ...
    def test_topicbox_source_centerpage_form_saves_values(self):
        ...
        self.assertEqual([
            'centerpage'], b.getControl('Source').displayValue)
    ...
    def test_topicbox_source_topicpage_form_saves_values(self):
        ...
        b.getControl('Source').displayValue = ['topicpage']
        ...
        self.assertEqual([
            'topicpage'], b.getControl('Source').displayValue)
    ...
    def test_topicbox_source_elasticsearch_form_saves_values(self):
        ...
        b.getControl('Source').displayValue = ['elasticsearch-query']
        ...
        self.assertEqual([
            'elasticsearch-query'], b.getControl('Source').displayValue)
    ...
    def test_topicbox_source_related_api_form_saves_values(self):
        ...
        b.getControl('Source').displayValue = ['related-api']
        ...
        self.assertEqual([
            'related-api'], b.getControl('Source').displayValue)
    ...
    def test_topicbox_source_config_form_saves_values(self):
        ...
        b.getControl('Source').displayValue = ['config-query']
        b.getControl('Config-Query').displayValue = ['(nothing selected)']
        b.getControl('Apply').click()
        b.open('@@edit-%s?show_form=1' % self.block_type)
        ...
        self.assertEqual([
            'config-query'], b.getControl('Source').displayValue)
