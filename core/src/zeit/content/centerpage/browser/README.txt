...
<ItemControl name='form.dailyNewsletter' type='checkbox' optionValue='on' selected=...>
>>> browser.getControl('Daily newsletter').selected = False
>>> browser.getControl('Apply').click()
...
<?xml ...
<!DOCTYPE ...
    <title> Homepagevorlage – Edit webdav properties </title>
    ...
