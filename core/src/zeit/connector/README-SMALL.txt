...
Creating a connector::
  ...
  >>> from zeit.connector.connector import Connector, resourceCacheFactory
...
Verify the IConnector interface::
  ...
  >>> from zeit.cms.interfaces import IConnector
...
Set up a site::
    ...
    ...         ISite, IContainmentRoot, IAttributeAnnotatable)
    ...
...
Get an object. We will get a cached resource::
    ...
    >>> ressource
    <zeit.connector.connector.CachedResource object at 0x...>
...
object first::
    ...
    >>> coll = zeit.cms.connector.Resource(
