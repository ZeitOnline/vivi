...
def upgrade() -> None:
    ...
    op.add_column('properties', sa.Column('image_height', sa.SmallInteger(), nullable=True))
    op.add_column('properties', sa.Column('image_width', sa.SmallInteger(), nullable=True))
