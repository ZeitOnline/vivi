...
class TestTags(zeit.retresco.testing.FunctionalTestCase, zeit.retresco.testing.TagTestHelpers):
    ...
    def test_read_and_write_values_to_tagger_does_not_change_intrafind_keyword(self):
