...
Check the document out by clicking on the link::
  ...
  <?xml version...
  <!DOCTYPE ...
    Unbekannte Resource – sie kann nicht bearbeitet oder angezeigt werden.
    ...
  >>> browser.url
  'http://localhost/++skin++cms/workingcopy/zope.globalmgr/rauchen-verbessert-die-welt/@@edit.html'
