...
class Placeholder(zeit.cms.testing.ZeitCmsTestCase):
    def setUp(self):
        super().setUp()
        self.form = ExampleAddForm(object(), zope.publisher.browser.TestRequest())
        self.form.factory = object

    def test_text_input_widgets_get_placeholder(self):
        self.form.setUpWidgets()
        self.assertEqual('placeholder="text line"', self.form.widgets['line'].extra)

    def test_textarea_widgets_get_placeholder(self):
        self.form.setUpWidgets()
        self.assertEqual('placeholder="text"', self.form.widgets['text'].extra)
    ...
    def test_placeholder_is_looked_up_in_fields_tagged_values(self):
        self.form.setUpWidgets()
        self.assertEqual('placeholder="customised"', self.form.widgets['special'].extra)


class CharlimitForm(zeit.cms.browser.form.EditForm, zeit.cms.browser.form.CharlimitMixin):
