...
zc_table = Library('zc.table', str((importlib.resources.files('zc.table') / 'resources')))
zc_table_js = fanstatic.Resource(zc_table, 'sorting.js')
register(zc_table_js)


zc_datetimewidget = Library(
    'zc.datetimewidget', str((importlib.resources.files('zc.datetimewidget') / 'resources'))
)
...
datetime_calendar_en_js = fanstatic.Resource(
    zc_datetimewidget, 'languages/calendar-en.js', depends=[datetime_calendar_js]
)
datetime_widget_js = fanstatic.Resource(
    ...
    depends=[
        datetime_css,
        datetime_calendar_en_js,
        datetime_calendar_setup_js,
    ],
)
