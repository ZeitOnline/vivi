...
class IProduct(zope.interface.Interface):
    ...
    vivi_title = zope.interface.Attribute('override title for vivi only')
...
class IContentModifiedEvent(zope.interface.interfaces.IObjectEvent):
    """IObjectModifiedEvent would be preferable, but is too entagled with zope.formlib"""
...
class ContentModifiedEvent(zope.interface.interfaces.ObjectEvent):
    """ObjectModifiedEvent would be preferable, but is too entagled with zope.formlib"""
