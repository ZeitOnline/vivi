...
@grok.implementer(IScheduledOperationsExecutor)
class RepositoryScheduledOperationsExecutor(grok.Adapter):
    """Execute scheduled operations for repository content."""
    ...
    def execute(self, operation):
        ...
        if operation.operation == 'publish':
            ...
            operation.executed_on = pendulum.now('UTC')
            log.debug(
